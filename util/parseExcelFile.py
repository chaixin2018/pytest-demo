...
class ParseExcel(object):
    ...
    def get_row_num(self, sheet):
        """获取有效数据的最大行号"""
        """sheet是对象，通过get_sheet_by_name(self, sheet_name)获取"""
...
if __name__ == '__main__':
    ...
    print(ParseExcel.get_sheet_by_name("login"))
    print(ParseExcel.get_value_of_cell(ParseExcel.get_sheet_by_name("login"), 2, 2))
    print(ParseExcel.get_row_num(ParseExcel.get_sheet_by_name("login")))